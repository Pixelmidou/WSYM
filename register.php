...
if ($con->connect_error) {
    ...
    if (isset($_POST['register_submit'])) {
        ...
        <?php } else {
            ...
            if (mysqli_query($con,"INSERT INTO login_credentials VALUES ('$username','$password','$email',now(),NULL,'none')") && mysqli_query($con,"INSERT INTO balance VALUES ('$username','$email','0')") && mysqli_query($con,"INSERT INTO blacklist VALUES ('$username', '1', '1', '1', '1', '1')")) { ?>
                <!DOCTYPE html>
                <html lang="en">
                <head>
                    <meta charset="UTF-8">
